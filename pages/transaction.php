                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card product-card h-100 shadow-sm">
                                        ...
                                        <div class="p-3 text-center">
                                            ...
                                            <div class="mt-2">
                                                <img src="assets/uploads/<?= $product["product_image"] ?>" width="150" height=150"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content rounded-4 shadow-lg border-0">
            ...
            <form action="" method="POST">
                <div class="modal-body p-4">
                    <input type="text" id="cart-data" name="cart-data" class="form-control mb-3">
...
<script>
    ...
    function renderCart() {
        ...
        if(cart.length === 0) {
            containerCart.innerHTML = "<p class='text-muted text-center py-3'>Cart is empty</p>"
        }
    ...
    function updateCart() {
        ...
        const cartModal = document.querySelector('#paymentModal');
        if (cartModal){
